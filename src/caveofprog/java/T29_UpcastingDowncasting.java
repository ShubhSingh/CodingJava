...
class Camera extends NewMachine {
	public void start() {
...
public class T29_UpcastingDowncasting {
	...
	public static void main(String[] args) {
		...
		NewMachine machine1 = new NewMachine();
		...
		NewMachine machine2 = camera1; // Here I took a variable of type Camera that refers to a Camera object and I've made the variable of type Machine refer to that object. So we have upcasted camera1 to machine1. We say UPcasted because we've gone up on hierarchy.
		...
		// DOWNCASTING
		NewMachine machine3 = new Camera();
