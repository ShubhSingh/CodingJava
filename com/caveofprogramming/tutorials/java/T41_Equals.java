...
public class T41_Equals {
	...
	public static void main(String[] args) {
		...
		PersonInfo person1 = new PersonInfo(5, "Bob");
		PersonInfo person2 = new PersonInfo(8, "Sue");
		PersonInfo person3 = new PersonInfo(8, "Sue");
		PersonInfo person4 = person3;
